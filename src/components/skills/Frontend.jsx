      ...
      <div className="skills_box">
        <div className="skills__group">
          <div className="skills__data">
            ...
            <div>
              <h3 className="skils__name">HTML & CSS</h3>
          ...
          <div className="skills__data">
            <i class="bx bx-badge-check"></i>
            <div>
              <h3 className="skils__name">Figma</h3>
            </div>
          </div>
          ...
          <div className="skills__data">
            <i class="bx bx-badge-check"></i>
            <div>
              <h3 className="skils__name">PHP</h3>
            </div>
          </div>
          ...
          <div className="skills__data">
            <i class="bx bx-badge-check"></i>
            <div>
              <h3 className="skils__name">Python</h3>
            </div>
          </div>
          ...
          <div className="skills__data">
            <i class="bx bx-badge-check"></i>
            <div>
              <h3 className="skils__name">React.js</h3>
            </div>
          </div>
